        ...
        <div id="tabs" class="flex justify-start items-center py-4">
          ...
          <div class="flex items-center ml-4">
            <div class="relative shrink">
              <form>
                <input v-model="order_sn" type="text" name="order_sn"
                  ...
                  <tbody class="bg-white dark:bg-slate-800">
                    <tr v-for="order in info.results">
                      ...
                      <td
                        ...
                        <button v-if="order.pay_status == 'PAYING'" v-on:click="pay(order)"
                        ...
                        <button v-else-if="order.pay_status == 'TRADE_CLOSED'"
                          class="rounded border bg-gray-500 text-white text-sm h-8 w-16 cursor-not-allowed">已关闭
                        </button>
                        <button v-else-if="order.pay_status == 'TRADE_SUCCESS' || order.pay_status == 'TRADE_FINISHED'"
                          class="rounded border bg-blue-500 text-white text-sm h-8 w-16 cursor-default">已完成
                        </button>
                      </td>
                    </tr>
                  </tbody>
